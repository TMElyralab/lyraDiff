...
#include "src/lyradiff/layers/flux_single_transformer_block/FluxSingleTransformerInt4BlockWeight.h"
...
#include "src/lyradiff/layers/flux_transformer_block/FluxTransformerInt4BlockWeight.h"
...
namespace lyradiff {
template<typename T>
class FluxTransformer2DModelWeight: public IFLoraWeight<T> {
private:
...
public:
    ...
    AdaLayerNormWeight<T>*                               norm_weight;

    FluxTransformer2DModelWeight(const size_t        input_channels        = 64,
