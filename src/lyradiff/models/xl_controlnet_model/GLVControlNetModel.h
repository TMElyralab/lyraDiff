...
template<typename T>
class GLVControlNetModel: public BaseLayer {
private:
...
public:
    ...
    GLVControlNetModel(const bool       is_reuse_unet_blocks,
    ...
    GLVControlNetModel(GLVControlNetModel<T> const& other);

    virtual ~GLVControlNetModel();
