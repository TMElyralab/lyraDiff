...
namespace lyradiff {
template<typename T>
XLCrossAttnUpBlock2d<T>::XLCrossAttnUpBlock2d(const size_t     in_channels,
    ...
    stream_assistant_(stream_assistant)
{
    ...
    xltransformer2d_block_3 = new XLTransformer2dBlock<T>(out_channels_,
                                                          head_num_,
                                                          out_channels_ / head_num_,
                                                          cross_attn_dim_,
                                                          norm_num_groups_,
...
template<typename T>
XLCrossAttnUpBlock2d<T>::XLCrossAttnUpBlock2d(XLCrossAttnUpBlock2d<T> const& xlcross_attn_up_block2d):
    ...
    stream_assistant_(xlcross_attn_up_block2d.stream_assistant_)
{
    ...
    xltransformer2d_block_1 = xlcross_attn_up_block2d.xltransformer2d_block_1;
    xltransformer2d_block_2 = xlcross_attn_up_block2d.xltransformer2d_block_2;
    xltransformer2d_block_3 = xlcross_attn_up_block2d.xltransformer2d_block_3;
...
template<typename T>
XLCrossAttnUpBlock2d<T>::~XLCrossAttnUpBlock2d()
{
    FT_LOG_DEBUG(__PRETTY_FUNCTION__);
    cublas_wrapper_ = nullptr;
    delete xltransformer2d_block_1;
    delete xltransformer2d_block_2;
    delete xltransformer2d_block_3;
...
template<typename T>
void XLCrossAttnUpBlock2d<T>::allocateBuffer()
{
    LYRA_CHECK_WITH_INFO(
        false,
        "XLCrossAttnUpBlock2d::allocateBuffer() is deprecated. Use `allocateBuffer(size_t token_num, ...)` instead");
}
    ...
    size_t batch_size, size_t height, size_t width, size_t target_height, size_t target_width)
{
    ...
    hidden_state_buf1_ =
        (T*)allocator_->reMallocWithName("XLCrossAttnUpBlock2d_hidden_state_buf1_", hidden_state_size, false);
    hidden_state_buf2_ =
        (T*)allocator_->reMallocWithName("XLCrossAttnUpBlock2d_hidden_state_buf2_", hidden_state_size, false);
    cat_buf1_ = (T*)allocator_->reMallocWithName("XLCrossAttnUpBlock2d_cat_buf1_", cat1_size, false);
    cat_buf2_ = (T*)allocator_->reMallocWithName("XLCrossAttnUpBlock2d_cat_buf2_", cat2_size, false);
    cat_buf3_ = (T*)allocator_->reMallocWithName("XLCrossAttnUpBlock2d_cat_buf3_", cat3_size, false);
    interpolate_buf_ =
        (T*)allocator_->reMallocWithName("XLCrossAttnUpBlock2d_interpolate_buf_", interpolate_size, false);

    is_allocate_buffer_ = false;
}

template<typename T>
void XLCrossAttnUpBlock2d<T>::freeBuffer()
{
    FT_LOG_DEBUG(__PRETTY_FUNCTION__);
...
template<typename T>
void XLCrossAttnUpBlock2d<T>::forward(std::vector<lyradiff::Tensor>*         output_tensors,
...
template<typename T>
void XLCrossAttnUpBlock2d<T>::forward(TensorMap*                           output_tensors,
                                      ...
                                      const XLCrossAttnUpBlock2dWeight<T>* weights)
{
    ...
    xltransformer2d_block_1->forward(&output_map, &input_map, weights->xltransformer2d_block_weight1);
    ...
    xltransformer2d_block_2->forward(&output_map, &input_map, weights->xltransformer2d_block_weight2);
    ...
    input_map = TensorMap({{"hidden_states", output_tensor1}, {"encoder_hidden_states", encoder_hidden_states}})
                    .setContextThis(input_tensors);
    output_map = TensorMap({{"output", output_tensor2}});
    xltransformer2d_block_3->forward(&output_map, &input_map, weights->xltransformer2d_block_weight3);

    // output_map.at("output").saveNpy("/home/mount/data/debug/up1_xt3_out.npy");
    ...
    // interpolate_t.saveNpy("/home/mount/data/debug/up1_interpolate.npy");
...
template class XLCrossAttnUpBlock2d<float>;
template class XLCrossAttnUpBlock2d<half>;
}  // namespace lyradiff