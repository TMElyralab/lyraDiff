...
struct Flash_fwd_kernel_traits: public Base {
    ...
    using GmemTiledCopyO   = decltype(make_tiled_copy(
        Copy_Atom<DefaultCopy, Element>{}, GmemLayoutAtom{}, Layout<Shape<_1, _8>>{}));  // Val layout, 8 vals per store
...
struct Flash_bwd_kernel_traits: public Base {
    ...
    using TiledMmaSdP = TiledMMA<typename Base::MMA_Atom_Arch,
    ...
    using TiledMmadKV = TiledMMA<typename Base::MMA_Atom_Arch,
    ...
    using GmemTiledCopydQ  = decltype(make_tiled_copy(Copy_Atom<DefaultCopy, elem_type>{},
                                                     GmemLayoutAtom{},
                                                     Layout<Shape<_1, _8>>{}));  // Val layout, 8 vals per store
    using GmemLayoutAtomdQaccum = std::conditional_t<kBlockKSmem == 32,
