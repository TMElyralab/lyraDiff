...
template<typename T>
class FluxSingleAttentionInt4Processor: public FluxSingleAttentionProcessor<T> {
private:
...
public:
    FluxSingleAttentionInt4Processor(size_t           embedding_dim,
    ...
    FluxSingleAttentionInt4Processor(FluxSingleAttentionInt4Processor<T> const& other);

    virtual ~FluxSingleAttentionInt4Processor();
