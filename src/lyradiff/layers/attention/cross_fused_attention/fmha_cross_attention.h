...
////////////////////////////////////////////////////////////////////////////////////////////////////
static void set_alpha(uint32_t& alpha, float norm, lyradiff::cross_attn::MHCADataType dtype)
{
    if (dtype == lyradiff::cross_attn::DATA_TYPE_FP16) {
        half     x  = __float2half_rn(norm);
        uint16_t h  = reinterpret_cast<uint16_t const&>(x);
        ushort2  h2 = {h, h};
        alpha       = reinterpret_cast<uint32_t const&>(h2);
    }
    else if (dtype == lyradiff::cross_attn::DATA_TYPE_FP32) {
        alpha = reinterpret_cast<uint32_t const&>(norm);
    }
    else if (dtype == lyradiff::cross_attn::DATA_TYPE_INT32) {
...
static int64_t get_size_in_bytes(size_t n, lyradiff::cross_attn::MHCADataType dtype)
{
    switch (dtype) {
        case lyradiff::cross_attn::DATA_TYPE_E8M10:
            return n * 4;
        case lyradiff::cross_attn::DATA_TYPE_FP32:
            return n * 4;
        case lyradiff::cross_attn::DATA_TYPE_FP16:
            return n * 2;
        case lyradiff::cross_attn::DATA_TYPE_INT32:
            return n * 4;
        case lyradiff::cross_attn::DATA_TYPE_INT8:
            return n;
        case lyradiff::cross_attn::DATA_TYPE_INT4:
            return n / 2U;
        case lyradiff::cross_attn::DATA_TYPE_BOOL:
            return n / 8U;
        case lyradiff::cross_attn::DATA_TYPE_E8M7:
            return n * 2;
        default:
            PLUGIN_ASSERT(false);
            return 0;
...
static const struct FusedMultiHeadCrossAttentionKernelMetaInfoV2 {
    ...
    {DATA_TYPE_FP16,
     ...
     64,
     kSM_75,
     cubin_fmha_mhca_fp16_128_64_sm75_cu_cubin,
     cubin_fmha_mhca_fp16_128_64_sm75_cu_cubin_len,
     "fmha_mhca_fp16_128_64_sm75_kernel",
     40960,
     128,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_64_sm75_cu_cubin,
     cubin_fmha_mhca_fp16_128_64_sm75_cu_cubin_len,
     "fmha_mhca_fp16_128_64_sm75_kernel_nl",
     36864,
     128,
     32,
     false},
    {DATA_TYPE_FP16,
     ...
     128,
     kSM_75,
     cubin_fmha_mhca_fp16_128_128_sm75_cu_cubin,
     cubin_fmha_mhca_fp16_128_128_sm75_cu_cubin_len,
     "fmha_mhca_fp16_128_128_sm75_kernel",
     81920,
     128,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_128_sm75_cu_cubin,
     cubin_fmha_mhca_fp16_128_128_sm75_cu_cubin_len,
     "fmha_mhca_fp16_128_128_sm75_kernel_nl",
     40960,
     128,
     32,
     false},
...
// No support for D=160 on Turing.
    ...
    {DATA_TYPE_FP16,
     ...
     64,
     kSM_80,
     cubin_fmha_mhca_fp16_128_64_sm80_cu_cubin,
     cubin_fmha_mhca_fp16_128_64_sm80_cu_cubin_len,
     "fmha_mhca_fp16_128_64_sm80_kernel",
     49152,
     128,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_64_sm80_cu_cubin,
     cubin_fmha_mhca_fp16_128_64_sm80_cu_cubin_len,
     "fmha_mhca_fp16_128_64_sm80_kernel_nl",
     49152,
     128,
     64,
     false},
    {DATA_TYPE_FP16,
     ...
     128,
     kSM_80,
     cubin_fmha_mhca_fp16_128_128_sm80_cu_cubin,
     cubin_fmha_mhca_fp16_128_128_sm80_cu_cubin_len,
     "fmha_mhca_fp16_128_128_sm80_kernel",
     98304,
     128,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_128_sm80_cu_cubin,
     cubin_fmha_mhca_fp16_128_128_sm80_cu_cubin_len,
     "fmha_mhca_fp16_128_128_sm80_kernel_nl",
     81920,
     128,
     32,
     false},
    {DATA_TYPE_FP16,
     ...
     256,
     kSM_80,
     cubin_fmha_mhca_fp16_128_256_sm80_cu_cubin,
     cubin_fmha_mhca_fp16_128_256_sm80_cu_cubin_len,
     "fmha_mhca_fp16_128_256_sm80_kernel",
     163840,
     256,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_256_sm80_cu_cubin,
     cubin_fmha_mhca_fp16_128_256_sm80_cu_cubin_len,
     "fmha_mhca_fp16_128_256_sm80_kernel_nl",
     147456,
     256,
     16,
     false},
    ...
    {DATA_TYPE_FP16,
     ...
     64,
     kSM_86,
     cubin_fmha_mhca_fp16_128_64_sm86_cu_cubin,
     cubin_fmha_mhca_fp16_128_64_sm86_cu_cubin_len,
     "fmha_mhca_fp16_128_64_sm86_kernel",
     49152,
     128,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_64_sm86_cu_cubin,
     cubin_fmha_mhca_fp16_128_64_sm86_cu_cubin_len,
     "fmha_mhca_fp16_128_64_sm86_kernel_nl",
     49152,
     128,
     64,
     false},
    {DATA_TYPE_FP16,
     ...
     128,
     kSM_86,
     cubin_fmha_mhca_fp16_128_128_sm86_cu_cubin,
     cubin_fmha_mhca_fp16_128_128_sm86_cu_cubin_len,
     "fmha_mhca_fp16_128_128_sm86_kernel",
     98304,
     128,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_128_sm86_cu_cubin,
     cubin_fmha_mhca_fp16_128_128_sm86_cu_cubin_len,
     "fmha_mhca_fp16_128_128_sm86_kernel_nl",
     98304,
     128,
     64,
     false},
    {DATA_TYPE_FP16,
     ...
     256,
     kSM_86,
     cubin_fmha_mhca_fp16_128_256_sm86_cu_cubin,
     cubin_fmha_mhca_fp16_128_256_sm86_cu_cubin_len,
     "fmha_mhca_fp16_128_256_sm86_kernel",
     163840,
     256,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_256_sm86_cu_cubin,
     cubin_fmha_mhca_fp16_128_256_sm86_cu_cubin_len,
     "fmha_mhca_fp16_128_256_sm86_kernel_nl",
     81920,
     256,
     16,
     false},
    ...
    {DATA_TYPE_FP16,
     ...
     64,
     kSM_89,
     cubin_fmha_mhca_fp16_128_64_sm89_cu_cubin,
     cubin_fmha_mhca_fp16_128_64_sm89_cu_cubin_len,
     "fmha_mhca_fp16_128_64_sm89_kernel",
     49152,
     128,
     0,
     false},
    {DATA_TYPE_FP16,
     ...
     cubin_fmha_mhca_fp16_128_64_sm89_cu_cubin,
     cubin_fmha_mhca_fp16_128_64_sm89_cu_cubin_len,
     "fmha_mhca_fp16_128_64_sm89_kernel_nl",
     49152,
     128,
     64,
     false},
    {DATA_TYPE_FP16,
     ...
     128,
     kSM_89,
     cubin_fmha_mhca_fp16_128_128_sm89_cu_cubin,
     cubin_fmha_mhca_fp16_128_128_sm89_cu_cubin_len,
     "fmha_mhca_fp16_128_128_sm89_kernel",
     98304,
     128,
     0,
     false},
    ...
    {DATA_TYPE_FP16,
     ...
     256,
     kSM_89,
     cubin_fmha_mhca_fp16_128_256_sm89_cu_cubin,
     cubin_fmha_mhca_fp16_128_256_sm89_cu_cubin_len,
     "fmha_mhca_fp16_128_256_sm89_kernel",
     163840,
     256,
     0,
     false},
...
static Fused_multihead_attention_params_mhca getMHCAParams(
    // types
    MHCADataType data_type,
    MHCADataType acc_type,
    // sizes
    int32_t b,
    int32_t s_q,
    int32_t s_kv,
    ...
    int32_t total,
    // device pointers
    void const* q_packed_d,
    void const* kv_packed_d,
    void*       cu_seqlens_q_d,
