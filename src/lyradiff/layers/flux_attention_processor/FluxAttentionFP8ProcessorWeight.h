...
template<typename T>
class FluxAttentionFP8ProcessorWeight: public FluxAttentionProcessorWeight<T> {
private:
...
public:
    ...
    FluxAttentionFP8ProcessorWeight() = default;
    FluxAttentionFP8ProcessorWeight(size_t        embedding_dim,
                                    size_t        embedding_head_num,
                                    size_t        embedding_head_dim,
                                    LyraQuantType quant_level,
                                    IAllocator*   allocator);

    virtual ~FluxAttentionFP8ProcessorWeight();
